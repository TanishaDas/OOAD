...
public class CeaserCypherUI extends AppLayout {
    private final  cipher c = new CeaserCypher();
    public CeaserCypherUI() {
        ...
        TextField resultField1 = new TextField("Encrypted Text");
        TextField resultField2 = new TextField("Decrypted Text");

        // Vertical layout containing text fields and button
        VerticalLayout verticalLayout = new VerticalLayout();
        verticalLayout.add(phoneNumberField,upload, anotherField, button, resultField1);
        ...
        button.addClickListener(event -> {
            String plainText = phoneNumberField.getValue();
            int shift = Integer.parseInt(anotherField.getValue());
            String encryptedText = c.encrypt(plainText, shift);
            resultField1.setValue(encryptedText);
        });
        button2.addClickListener(event -> {
            String encryptedText = phoneNumberField2.getValue();
            int shift = Integer.parseInt(anotherField2.getValue());
            String decryptedText = c.decrypt(encryptedText, shift);
            resultField2.setValue(decryptedText);
        });

        // Vertical layout containing second set of text fields and button
        VerticalLayout verticalLayout2 = new VerticalLayout();
        verticalLayout2.add(phoneNumberField2, upload2, anotherField2, button2,resultField2);
